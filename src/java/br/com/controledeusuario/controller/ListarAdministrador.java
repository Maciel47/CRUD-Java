...
public class ListarAdministrador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            GenericDAO daoadministrador = new AdministradorDAOImpl();
            request.setAttribute("listaradministrador", daoadministrador.listar());
            
            request.getRequestDispatcher("administrador/gerenciaradministrador.jsp")
                    .forward(request, response);            
        }catch(Exception ex){
            System.out.println("Erro ao ListarAdministrador");
            ex.printStackTrace();
        }       
    }
